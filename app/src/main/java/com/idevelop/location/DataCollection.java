...
import com.idevelop.location.R;
...
//                    }
                ...
                if (accChecked) {
                    ...
                    if (mSensorAccelerometer != null) {
                        mSensorManager.registerListener(DataCollection.this, mSensorAccelerometer,
                ...
                if (magnChecked) {
                    ...
                    if (mSensorMagnetometer != null) {
                        mSensorManager.registerListener(DataCollection.this, mSensorMagnetometer,
                                SensorManager.SENSOR_DELAY_NORMAL);
                    }
                }
                if (gyroChecked) {
                    ...
                    if (mSensorGyroscope != null) {
                        mSensorManager.registerListener(DataCollection.this, mSensorGyroscope,
                                SensorManager.SENSOR_DELAY_NORMAL);
                    }
                }
                //stepsCounter
                if (stepsCheck) {
                    ...
                    if (StepsAccount != null) {
                        mSensorManager.registerListener(DataCollection.this, StepsAccount,
                                SensorManager.SENSOR_DELAY_NORMAL);
                ...
                if(nmbrOfCheck != 0) {
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mSensorManager.unregisterListener(DataCollection.this);
                            ...
                            if(acclDataCollection.size() != 0){
                                ...
                                resulty = " "+ result[1];
                                resultz = " "+ result[2];
                                x_accMean.setText(resultx);
                                y_accMean.setText(resulty);
                                z_accMean.setText(resultz);
                            ...
                            if(magnDataCollection.size() != 0){
                                ...
                                resulty = " "+ result[1];
                                resultz = " "+ result[2];
                                x_magMean.setText(resultx);
                                y_magMean.setText(resulty);
                                z_magMean.setText(resultz);
                            ...
                            if(gyroDataCollection.size() != 0){
                                ...
                                resulty = " "+ result[1];
                                resultz = " "+ result[2];
                                x_gyroMean.setText(resultx);
                                y_gyroMean.setText(resulty);
                                z_gyroMean.setText(resultz);
...
//                z_accMean.setText(getResources().getString(R.string.z_axis, accl_mean[2]));
    ...
    public void onCheckboxStep(View view) {
        if(stepsCheck){
            ...
            chechbox_steps.setTextColor(Color.parseColor("#ff547f"));
        }
    ...
    private void populateSpinnerGeste() {
       /* ArrayAdapter<String> gesteAdapter = new ArrayAdapter<>(this,android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.spenner_geste));
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>( DataCollection.this, android.R.layout.simple_spinner_dropdown_item) {
            @Override
    ...
    /*public int GetDelay(){
        ...
        Toast.makeText(DataCollection.this," Durée: "+delay,Toast.LENGTH_SHORT).show();
        return delay;}*/
    ...
    private void saveData(){
        ...
        Log.d(String.valueOf(DataCollection.this),"§savedNumber");
    ...
    public void RegisterInCSVfile(View view) {
        String x_acc = x_accMean.getText().toString();
        String y_acc = y_accMean.getText().toString();
        String z_acc = z_accMean.getText().toString();
        String x_gyr = x_gyroMean.getText().toString();
        String y_gyr = x_gyroMean.getText().toString();
        String z_gyr = x_gyroMean.getText().toString();
        String x_mag = x_magMean.getText().toString();
        String y_mag = x_magMean.getText().toString();
        String z_mag = x_magMean.getText().toString();
        String c_steps = String.valueOf(StepsSave);


        if(!accChecked){Toast.makeText(DataCollection.this, "Check Accelerometer", Toast.LENGTH_SHORT).show();}
        if(!gyroChecked){Toast.makeText(DataCollection.this, "Check Gyroscope", Toast.LENGTH_SHORT).show();}
        if(!magnChecked){Toast.makeText(DataCollection.this, "Check Magnetometer", Toast.LENGTH_SHORT).show();}
        if(!stepsCheck){Toast.makeText(DataCollection.this, "Check Steps", Toast.LENGTH_SHORT).show();}
        if (spinnergeste.getSelectedItem().toString() == "Select Gesture") {
            Toast.makeText(DataCollection.this, "Select Gesture", Toast.LENGTH_SHORT).show();}
        ...
        if (!spinnergeste.getSelectedItem().toString().equals("Select Gesture") &&
            ...
            String entry = x_accMean.getText().toString() + ";" +
                    y_accMean.getText().toString() + ";" +
                    z_accMean.getText().toString() + ";" +
                    x_gyroMean.getText().toString() + ";" +
                    y_gyroMean.getText().toString() + ";" +
                    z_gyroMean.getText().toString() + ";" +
                    x_magMean.getText().toString() + ";" +
                    y_magMean.getText().toString() + ";" +
                    z_magMean.getText().toString() + ";" +
            ...
            try {
                ...
                out.println(entry);
                out.close();
                Toast.makeText(DataCollection.this, " Saved! ", Toast.LENGTH_SHORT).show();
                x_accMean.setText("");y_accMean.setText("");z_accMean.setText("");
                x_gyroMean.setText("");y_gyroMean.setText("");z_gyroMean.setText("");
                x_magMean.setText("");y_magMean.setText("");z_magMean.setText("");
                StepsSave = -1;
            } catch (FileNotFoundException e) {
                e.printStackTrace();
                Toast.makeText(DataCollection.this, " File not Found! ", Toast.LENGTH_SHORT).show();
            } catch (IOException e) {
                e.printStackTrace();
                Toast.makeText(DataCollection.this, " Error Saving! ", Toast.LENGTH_SHORT).show();
            }

        }else {Toast.makeText(DataCollection.this, "Collect DATA First", Toast.LENGTH_SHORT).show(); }
